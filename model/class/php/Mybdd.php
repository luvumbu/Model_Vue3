...
$apple->set_row_array_number("club_nom");
$apple->set_row_array_number("club_region");

 
$apple->execute();  

echo $apple->get_row_array_combine("club_region");
//echo $apple->get_number_row_array_number(0);
